                    ...
                    <ul class="navbar-nav ms-auto" style="list-style-type: none;">              
                     ...
                     <!--   <li><i id="info" style="font-size: 20px;" class="far fa-heart"></i></li>
                        <li><img src="../resources/images/ICONOS/MENSAJES.png" id="chat" alt=""></li>
                         ...
                         <img src="/WolfChat/public/storage/{{ Auth::user()->foto_user }}" class="foto_perfil"  width="50" height="60" alt="">
                        @guest
                            @if (Route::has('login'))
                                <li class="nav-item">
                        ...
                        @else
                            ...
                            <li id="fotoflex" class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
									...
									<a class="dropdown-item" href="../public/editUser/{{ Auth::user()->id}}">Perfil</a>

                                    <a class="dropdown-item" href="../public/editUser/{{ Auth::user()->id}}/edit">Editar datos</a>
