...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="apellidos" type="text" class="form-control" name="apellidos" placeholder="Apellidos" value="<?php echo e(old('apellidos')); ?>" required autocomplete="apellidos" autofocus>
                            </div>
                        </div>
...
unset($__errorArgs, $__bag); ?>" placeholder="Contraseña" name="password" required autocomplete="new-password">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
						            ...
						            <select class="form-select" name="u_country" required="required" >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
						            <span class="input-group-addon"><i class="glyphicon glyphicon-chevron-down"></i></span>
						            <select class="form-select input-md" name="u_gender" required="required">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\proyecto9no\resources\views/auth/register.blade.php ENDPATH**/ ?>