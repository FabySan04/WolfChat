                        ...
                        <?php else: ?>
                            ...
                            <li id="fotoflex" class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
									...
									<a class="dropdown-item" href="../editUser/<?php echo e(Auth::user()->id); ?>">Perfil</a>

                                    <a class="dropdown-item" href="../editUser/<?php echo e(Auth::user()->id); ?>/edit">Editar datos</a>
...
</style><?php /**PATH C:\xampp\htdocs\WolfChat\resources\views/layouts/headerP.blade.php ENDPATH**/ ?>